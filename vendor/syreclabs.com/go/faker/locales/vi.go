...
var Vi = map[string]interface{}{
	...
	"name": map[string]interface{}{
		...
		"name": []string{
			"#{name.first_name} #{name.last_name}", "#{name.first_name} #{name.last_name} #{name.last_name}", "#{name.first_name} #{name.last_name} #{name.last_name} #{name.last_name}",
		},
	},
